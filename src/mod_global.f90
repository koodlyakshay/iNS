...
real*8              :: dx,dy,Area,Normal,Lx,Ly,xmin,ymin,Res_mass,alfa,kappa
...
real*8              :: V_e,V_w,V_n,V_s,U_up,V_up,FaceFlux,mass_in,mass_out
real*8,allocatable  :: x(:,:),y(:,:),Mass(:),D(:,:),P_Correc(:),Vol(:), Vel_Corr(:,:)
